...
console.log('Nosso Heroi será capaz de derrotar o Basilisco para conseguir sua presa?')
const resp4 = prompt ()
if (resp4 === 'sim'){
  var val4  = 1
    console.log('Parabens grande Heroi, vc foi capaz de derrotar o temível Basilisco e pegar sua presa!.')
}else if (resp4 === 'nao' ){
    var val4 = 0
    console.log('Sabia escolha, vc dara outro jeito!')
}
...
Se pensar em um bom plano ele pode até conseguir a flauta, se falahar poderá morrer.
...
if (resultado === 0){
    console.log('O Cavaleiro falhou miseravelmente, se tentar enfrentar o Dragão irá morrer e toda vila arderá em chamas!')
}else if ( resultado > 0, resultado <= 2){
    console.log(' O Cavaleiro falhou em derrotar o Dragão, mas será lembrado como um heroi por tentar!')
}else if( resultado === 3){
    console.log('Nosso Heroi após muito esforço causa serios danos ao Dragão que foge de Silent Hill, mas o Cavaleiro morre, aclamado como Heroi, após os graves ferimentos.')
} else if( resultado === 4){ 
    console.log('Muito bom!! O Cavaleiro consegue matar o Dragão e se torna um grande Heroi reconhecido em varios reinos, mas sai muito machucado e é obrigado a se aposentar com muita glória! ' )
}else if (resultado === 5){
    console.log('O Cavaleiro foi Incrível e Avassalador contra a furia do Dragão, é aclamado por vários reinos como um grande Heroi, o enchem de riquesas e titulos heróicos em vários reinos, sua história será contada por gerações. ')
}
